...
import { UserInterface } from "../../../../utils/typescript_interfaces/user";
const {UserInterface} = require("../../../../utils/typescript_interfaces/user")
...
const userSchema = new Schema({
    ...
    createdAt: {type: Date, required: [true, "Provide date"]}
})
